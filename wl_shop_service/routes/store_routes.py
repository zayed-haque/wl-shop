...
from wl_shop_service.schemas.store_schema import (store_inventory_schema,
                                                  store_schema,
                                                  stores_inventory_schema,
                                                  stores_schema)
...
def set_store_plan(store_id):
    ...
    try:
        ...
        return (
            jsonify(
                {"message": "Store plan updated successfully", "plan": updated_plan}
            ),
            200,
        )
    except KeyError:
